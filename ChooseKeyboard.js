  ...
  return (
      <SafeAreaView style={styles.container}>
          ...
          <Text style={padding(0,0,20,0)}>Keyboard type</Text>
             <TouchableOpacity 
              style ={styles.button}
              onPressIn={()=> {SetKeyboard('Braille'); nextpage();}}
              onPressOut={()=> {SetKeyboard('Braille'); nextpage();}}
              activeOpacity={0.5}
          >
              <Text>Braille</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity 
              style ={styles.button}
              onPressIn={()=> {SetKeyboard('Text'); nextpage();}}
              onPressOut={()=> {SetKeyboard('Text'); nextpage();}}              activeOpacity={0.5}
          >
              <Text>Text</Text>
          </TouchableOpacity>
    </SafeAreaView>
