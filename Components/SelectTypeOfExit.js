  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
          ...
          onPress={() => {
            Speech.speak('The choices are all in one row under this button from left to right respectively. Press one of the buttons to proceed. press Button on bottom screen to go back')
          }}
        >
        ...
        {modes_of_exit.some((e) => e === "Escalator") ? (
          ...
          onPress={navigateEs}
            >
              <Text style={styles.text}>Escalator</Text></TouchableOpacity>
        ) : null}
        {modes_of_exit.some((e) => e === "Elevator") ? (
          <TouchableOpacity style={styles.button}
          onPress={navigateEl}>
            <Text style={styles.text}>Elevator</Text></TouchableOpacity> 
        ) : null}
        {modes_of_exit.some((e) => e === "Stairs") ? (
          <TouchableOpacity style={styles.button}
          onPress={navigateSt}
            ><Text style={styles.text}>Stairs</Text></TouchableOpacity> 
        ) : null}
      </View>
