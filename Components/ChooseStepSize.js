...
const ChooseStepSize = ({ navigation }) => {
  ...
  const SaveAndNavigate = () => {
    ...
    if (!error) {
      ...
      Speech.speak('Incorrect step size! Step size must be between 0 metres to 1 metres')
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
          ...
          onPress={() => {
            Speech.speak('Enter your step size here, it must be between 0 and 1 meter. The keyboard is always there and numeric. Speak screen to check your stepsize. The submit button is on the top right of the keyboard. The back button is on the top left of the keyboard.')
          }}
        >
