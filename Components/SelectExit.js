  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
          ...
          onPress={() => {
            Speech.speak('On the bottom of the screen there are three buttons, Use the middle button to change exit choice. submit button is on the right, back button is on the left')
          }}
        >
      ...
      <View style={styles.parent}>
        ...
        <TouchableOpacity
          activeOpacity={0.5}
          style={styles.button}
          onPress={() => {update_exit(+1); Speech.speak(exits[exit_number+1])}}
        >
        ...
        <TouchableOpacity
          ...
          Speech.speak('submit, speak screen to hear the places near your chosen exit')}}
          >
