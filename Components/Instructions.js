...
const Instructions = ({ navigation }) => {
  React.useEffect(() => {
    const unsubscribe = navigation.addListener('focus', () => {
      Speech.speak('Speak screen to hear the instructions on how to use the app. For other screens, press the button on the top right of the screen to hear the instructions.')
    });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.parent}>
        <TouchableOpacity
          activeOpacity={0.5}
          style={styles.button}
          onPress={() => {navigation.navigate("Choose Step Size"); Speech.speak('Enter step size, the keyboard is numeric')}}
        >
